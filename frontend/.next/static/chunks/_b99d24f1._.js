...
"[project]/app/(dashboard)/approvals/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ApprovalsPage() {
    ...
    const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$app$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])({
        "ApprovalsPage.useAppStore[store]": (state)=>state.currentStore
    }["ApprovalsPage.useAppStore[store]"]);
    const workflow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$app$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])({
        "ApprovalsPage.useAppStore[workflow]": (state)=>state.workflow
    }["ApprovalsPage.useAppStore[workflow]"]);
    const setWorkflow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$app$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])({
        "ApprovalsPage.useAppStore[setWorkflow]": (state)=>state.setWorkflow
    }["ApprovalsPage.useAppStore[setWorkflow]"]);
    const appendWorkflowLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$app$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])({
        "ApprovalsPage.useAppStore[appendWorkflowLog]": (state)=>state.appendWorkflowLog
    }["ApprovalsPage.useAppStore[appendWorkflowLog]"]);
    const result = workflow.result;
    var _result_pending_approvals;
    const approvals = dedupeFixes((_result_pending_approvals = result === null || result === void 0 ? void 0 : result.pending_approvals) !== null && _result_pending_approvals !== void 0 ? _result_pending_approvals : []);
    const clearApprovals = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Pending fixes rejected locally");
    };
    const applyAll = async ()=>{
        if (!store) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Connect a store first");
        if (!approvals.length) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Approval queue is clear");
        setWorkflow({
            status: "running"
        });
        appendWorkflowLog("".concat(new Date().toLocaleTimeString(), "  Applying ").concat(approvals.length, " approved fixes"));
        try {
            var _applied_result, _applied_result1;
            const applied = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiApi"].applyApprovals(approvals, store.id);
            var _applied_result_executed;
            const executed = (_applied_result_executed = (_applied_result = applied.result) === null || _applied_result === void 0 ? void 0 : _applied_result.executed) !== null && _applied_result_executed !== void 0 ? _applied_result_executed : [];
            var _applied_result_failed;
            const failed = (_applied_result_failed = (_applied_result1 = applied.result) === null || _applied_result1 === void 0 ? void 0 : _applied_result1.failed) !== null && _applied_result_failed !== void 0 ? _applied_result_failed : [];
            ...
            appendWorkflowLog("".concat(new Date().toLocaleTimeString(), "  Approved fixes applied: ").concat(executed.length, " succeeded, ").concat(failed.length, " failed"));
            if (failed.length) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning("".concat(executed.length, " fixes applied, ").concat(failed.length, " could not be applied"));
            else __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Approved fixes applied. Run Store sync to refresh local data.");
        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$cards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageIntro"], {
                ...
                description: store ? "Approval gates for ".concat(store.shop_name || store.shop_domain, ".") : "Connect a store to review write approvals.",
            ...
            approvals.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid gap-4 md:grid-cols-2 xl:grid-cols-3",
                children: approvals.map((fix, index)=>{
                    var _fix_resource_type, _fix_field, _fix_confidence;
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            className: "p-5",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        (_fix_resource_type = fix.resource_type) !== null && _fix_resource_type !== void 0 ? _fix_resource_type : "resource",
                                        " Â· ",
                                        (_fix_field = fix.field) !== null && _fix_field !== void 0 ? _fix_field : "change"
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/app/(dashboard)/approvals/page.tsx",
                                    lineNumber: 57,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        "Confidence: ",
                                        Math.round(((_fix_confidence = fix.confidence) !== null && _fix_confidence !== void 0 ? _fix_confidence : 0) * 100),
                                        "%"
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/app/(dashboard)/approvals/page.tsx",
                    ...
                    }, "".concat(fix.resource_id, "-").concat(fix.field, "-").concat(index), false, {
                        fileName: "[project]/app/(dashboard)/approvals/page.tsx",
                        lineNumber: 57,
                        columnNumber: 1036
                    }, this);
...
_s(ApprovalsPage, "AXn52eSz/sqKRS0q/YrphqfIwco=", false, function() {
    return [
...
function formatFixValue(value) {
    ...
    if (typeof value === "object") {
        const data = value;
        return Object.entries(data).filter((param)=>{
            let [, item] = param;
            return item !== undefined && item !== null && item !== "";
        }).map((param)=>{
            let [key, item] = param;
            return "".concat(key.replace("seo_", "SEO "), ": ").concat(String(item));
        }).join("\n") || "Empty";
    }
    return String(value);
}
...
//# sourceMappingURL=_b99d24f1._.js.map