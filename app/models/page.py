...
class Page(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    """Local mirror of a Shopify online store page."""

    __tablename__ = "pages"
    __table_args__ = (UniqueConstraint("store_id", "shopify_id", name="uq_pages_store_shopify_id"),)
    ...
    store: Mapped["Store"] = relationship("Store", back_populates="pages")  # noqa: F821

    def __repr__(self) -> str:
        return f"<Page id={self.id} shopify_id={self.shopify_id} handle={self.handle!r}>"
